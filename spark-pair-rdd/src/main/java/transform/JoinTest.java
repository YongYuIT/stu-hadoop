...
public class JoinTest {
    public static void main(String[] args) {
        ...
        JavaRDD<String> tabName = sc.parallelize(Arrays.asList("1001 yuyong", "1002 benben", "1003 guo", "1004 fei"));
        JavaRDD<String> tabBook = sc.parallelize(Arrays.asList("1001 bookA", "1002 bookB", "1001 bookC", "1004 bookD"));
