...
public class TestTxtFile {
    ...
    /*
     * $ hdfs dfs -rm -r /user/yong/input/spark-partition
     * $ hdfs dfs -ls /user/yong/input/spark-partition
     * $ hdfs dfs -mkdir -p /user/yong/input/spark-partition
     * $ hdfs dfs -put /home/yong/stu-hadoop20190705001/spark-partition/test_data/* /user/yong/input/spark-partition/
     * $ hdfs dfs -ls /user/yong/input/spark-partition
     */
